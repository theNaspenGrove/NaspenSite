...
I host a Semi-Vanilla Minecraft server for my Supporters and Community members that can be joined by following me on Twitch or YouTube, as well as through the other methods mentioned [here](/Community-Server/Wiki/MinecraftAuth-Ranks) on the Community Server Wiki. The server is whitelisted using [MinecraftAuth](https://minecraftauth.me/) and requires on of the aforementioned ranks to be able to join, as well as your presence in my [Discord Server](https://discord.naspen.mov).  
  
There are a number of features that I've added to the server, and that feature list grows continually. You can find an up-to-date list of what's been added to the server [on the wiki](/Community-Server/Wiki/Server-Features/). 
