...
## Current Features 
 ...
 - Tridents work in the Nether when used on Lightning Rods. 
 - Tridents can summon lightening on Lightning Rods when left clicking on them. 
   - triggers a 1 seconds cool down for tridents and damages the trident. 
 - Lightning Rods break the bedrock they're attached to when struck. 
 - Lightning Rods "charge" TNT they activate by being attached to it when struck. 
   - The Charged TNT will glow. 
   - Charged TNT breaks bedrock. 
   - Charged TNT starts fire like Ghast fireballs/bed explosions. 
   - Charged TNT explosions are larger than normal TNT. 
 - Charged Creepers break bedrock. 
 - Iron Boots protect you from lightning damage. 
   - The boots take extra damage from the lightning unless they're trimmed with Copper. 
